...
public class busRoute100 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_route100);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.bus_route100, menu);
        return true;
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng startingLocation = new LatLng(6.7143461102121345, 79.90752907960416);
        LatLng destination = new LatLng(6.9343147971524175, 79.84857747821809);
        LatLng wayPoint1 = new LatLng(6.868699420833389, 79.86235742457211);
        LatLng wayPoint2 = new LatLng(6.893302521495292, 79.8555089905858);

        googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(startingLocation, 9));

        googleMap.addMarker(new MarkerOptions().position(startingLocation).title("Starting Location (Panadura SLBT)"));
        googleMap.addMarker(new MarkerOptions().position(destination).title("Ending Location (Colombo Fort)"));
        googleMap.addCircle(new CircleOptions().center(wayPoint1));
        googleMap.addCircle(new CircleOptions().center(wayPoint2));

        PolylineOptions polylineOptions = new PolylineOptions();

        polylineOptions.add(startingLocation, wayPoint1, wayPoint2, destination);
