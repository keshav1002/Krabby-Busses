...
public class busRoute1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_route1);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.bus_route1, menu);
        return true;
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng destination = new LatLng(7.291560334863875, 80.63362250595094);
        LatLng wayPoint1 = new LatLng(6.972008929842565, 79.91674298420548);
        LatLng wayPoint2 = new LatLng(7.23422892366997, 80.2601602037048);
        ...
        googleMap.addMarker(new MarkerOptions().position(destination).title("Ending Location (Kandy)"));
